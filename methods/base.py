...
class BaseMethod:
    ...
    def get_dataloader(self, batch_size, n_worker, train_list, test_list):
        ...
        test_loader = get_dataloader(pd.DataFrame(test_list), self.dataset, split='test', batch_size=128, num_class=self.num_class,
                                     num_workers=n_worker)
    ...
    def _compute_uncert(self, infer_list, infer_transform, uncert_name):
        ...
        infer_loader = get_dataloader(infer_df, self.dataset, split='test', batch_size=batch_size, num_class=self.num_class)
