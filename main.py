...
if __name__ == '__main__':
    ...
    if dataset == 'ESC-50' or dataset == 'Audioset':
    ...
    if model_name == 'baseline':
        model = Baseline_CNN(num_class=num_class if num_pretrain_class is None else num_pretrain_class, frontend=frontend)
    elif model_name == 'BC-ResNet':
        model = BCResNet_Mod(num_class=num_class if num_pretrain_class is None else num_pretrain_class, frontend=frontend)
    else:
        raise Exception
